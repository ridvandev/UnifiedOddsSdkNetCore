...
namespace Sportradar.OddsFeed.SDK.Entities.Internal.EntitiesImpl
{
        ...
        where T1 : ISportEvent
    {
        ...
        protected MarketMessage(IMessageTimestamp timestamp, IProducer producer, T1 sportEvent, long? requestId, IEnumerable<T> markets, byte[] rawMessage, string routingKey)
            : base(timestamp, producer, sportEvent, requestId, rawMessage, routingKey)
        {
