...
{
    [SuppressMessage("CodeQuality", "IDE0058:Expression value is never used",
        Justification = "Allowed for registering services")]
    internal static class UofSdkBootstrap
    {
        ...
        internal const string CacheStoreNameForInvariantMarketDescriptionsCache =
            "MemoryCacheForInvariantMarketDescriptionsCache";

        internal const string CacheStoreNameForVariantMarketDescriptionCache =
            "MemoryCacheForVariantMarketDescriptionCache";

        internal const string CacheStoreNameForVariantDescriptionListCache =
            "MemoryCacheForVariantDescriptionListCache";
        ...
        internal const string CacheStoreNameForSportEventCacheFixtureTimestampCache =
            "MemoryCacheForSportEventCacheFixtureTimestampCache";
        ...
        internal const string DataProviderForFixtureChangeFixtureEndpointForTournamentInfo =
            "DataProviderFixtureChangeFixtureEndpointForTournamentInfo";
        ...
        private static void RegisterBaseTypes(IServiceCollection services, IUofConfiguration configuration)
        {
            ...
            services.AddSingleton<ISemaphorePool, SemaphorePool>(serviceProvider =>
                new SemaphorePool(SdkInfo.SemaphorePoolSize, configuration.ExceptionHandlingStrategy,
                    serviceProvider.GetRequiredService<ILogger<SemaphorePool>>()));
        ...
        private static void RegisterHttpClients(IServiceCollection services, IUofConfiguration configuration)
        {
            var userAgentData =
                string.Intern(
                    $"UfSdk-{SdkInfo.SdkType}/{SdkInfo.GetVersion()} (OS: {Environment.OSVersion}, NET: {Environment.Version}, Init: {DateTime.UtcNow:yyyyMMddHHmm})");

            services.AddHttpClient(HttpClientNameForNormal)
                .ConfigureHttpClient(configureClient =>
                {
                    configureClient.Timeout = configuration.Api.HttpClientTimeout;
                    configureClient.DefaultRequestHeaders.Add(HttpClientDefaultRequestHeaderForAccessToken,
                        configuration.AccessToken);
                    configureClient.DefaultRequestHeaders.Add(HttpClientDefaultRequestHeaderForUserAgent,
                        userAgentData);
                })
                .ConfigurePrimaryHttpMessageHandler(() => new HttpClientHandler
                    { MaxConnectionsPerServer = configuration.Api.MaxConnectionsPerServer, AllowAutoRedirect = true });
            ...
            services.AddHttpClient(HttpClientNameForFastFailing)
                ...
                .ConfigurePrimaryHttpMessageHandler(() => new HttpClientHandler
                    { MaxConnectionsPerServer = configuration.Api.MaxConnectionsPerServer, AllowAutoRedirect = true });
            services.AddTransient<ISdkHttpClient, SdkHttpClient>(serviceProvider =>
                new SdkHttpClient(serviceProvider.GetRequiredService<IHttpClientFactory>(), HttpClientNameForNormal));
            services.AddTransient<ISdkHttpClientRecovery, SdkHttpClientRecovery>(serviceProvider =>
                new SdkHttpClientRecovery(serviceProvider.GetRequiredService<IHttpClientFactory>(),
                    HttpClientNameForRecovery));
            services.AddTransient<ISdkHttpClientFastFailing, SdkHttpClientFastFailing>(serviceProvider =>
                new SdkHttpClientFastFailing(serviceProvider.GetRequiredService<IHttpClientFactory>(),
                    HttpClientNameForFastFailing));

            var restTrafficLoggerName = SdkLoggerFactory.SdkLogRepositoryName + "." +
                                        Enum.GetName(typeof(LoggerType), LoggerType.RestTraffic);
        ...
        private static void RegisterBookmakerDetailsProvider(IServiceCollection services)
        {
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<bookmaker_details, BookmakerDetailsDto>,
                    BookmakerDetailsMapperFactory>();

            services.AddSingleton<IDataProvider<BookmakerDetailsDto>, Entities.Rest.Internal.BookmakerDetailsProvider>(
                servicesProvider =>
                    new Entities.Rest.Internal.BookmakerDetailsProvider(BookmakerDetailsProviderUrl,
                        ...
                        servicesProvider
                            .GetRequiredService<ISingleTypeMapperFactory<bookmaker_details, BookmakerDetailsDto>>()));
        ...
        private static void RegisterCacheStores(IServiceCollection services, IUofConfiguration configuration)
        {
            ...
            services.AddSdkCacheStore<string>(CacheStoreNameForVariantMarketDescriptionCache, null,
                configuration.Cache.VariantMarketDescriptionCacheTimeout, 20);
            services.AddSdkCacheStore<string>(CacheStoreNameForVariantDescriptionListCache);
            services.AddSdkCacheStore<string>(CacheStoreNameForProfileCache, null,
                configuration.Cache.ProfileCacheTimeout, 20); // could use 2 (also for simpleTeam)
            services.AddSdkCacheStore<string>(CacheStoreNameForFixtureChangeCache, null, TimeSpan.FromSeconds(10));
            services.AddSdkCacheStore<string>(CacheStoreNameForSportEventStatusCache,
                configuration.Cache.SportEventStatusCacheTimeout);
            services.AddSdkCacheStore<string>(CacheStoreNameForIgnoreEventsTimelineCache, null,
                configuration.Cache.IgnoreBetPalTimelineSportEventStatusCacheTimeout, 20);
            services.AddSdkCacheStore<string>(CacheStoreNameForSportEventCache, null,
                configuration.Cache.SportEventCacheTimeout, 20);
            services.AddSdkCacheStore<string>(CacheStoreNameForSportEventCacheFixtureTimestampCache,
        ...
        private static void RegisterSdkTimers(IServiceCollection services)
        {
            ...
            services.AddSdkTimer(TimerForInvariantMarketDescriptionsCache, TimeSpan.FromSeconds(5),
                TimeSpan.FromHours(6));
            services.AddSdkTimer(TimerForVariantMarketDescriptionListCache, TimeSpan.FromSeconds(5),
                TimeSpan.FromHours(6));
        ...
        {
            services
                .AddSingleton<ISingleTypeMapperFactory<sportEventStatus, SportEventStatusDto>,
                    SportEventStatusMapperFactory>();
            ...
            services.AddSingleton<ISportEventStatusCache, SportEventStatusCache>(serviceProvider =>
                new SportEventStatusCache(
                    ...
                    serviceProvider
                        .GetRequiredService<ISingleTypeMapperFactory<sportEventStatus, SportEventStatusDto>>(),
                    serviceProvider.GetRequiredService<ISportEventCache>(),
                    serviceProvider.GetRequiredService<ICacheManager>(),
        ...
        private static void RegisterBaseRabbitClasses(IServiceCollection services)
        {
            ...
            services.AddSingleton<IFeedMessageHandler, FeedMessageHandler>(serviceProvider =>
                new FeedMessageHandler(serviceProvider.GetSdkCacheStore<string>(CacheStoreNameForFixtureChangeCache)));
            ...
            services.AddScoped<IFeedMessageProcessor, SessionMessageManager>(serviceProvider =>
                (SessionMessageManager)serviceProvider.GetService<IAbstractFactory<IFeedRecoveryManager>>().Create()
                    .CreateSessionMessageManager());

            services.AddScoped(serviceProvider =>
                new CompositeMessageProcessor(serviceProvider.GetServices<IFeedMessageProcessor>().ToList()));
        }
        ...
        private static void RegisterApiClasses(IServiceCollection services, IUofConfiguration configuration)
        {
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<scheduleEndpoint, EntityList<SportEventSummaryDto>>,
                    SportEventsScheduleMapperFactory>();
        ...
        private static void RegisterDataRouterManager(IServiceCollection services, IUofConfiguration configuration)
        {
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<RestMessage, SportEventSummaryDto>,
                    SportEventSummaryMapperFactory>();
            ...
            services.AddSingleton<IDataProvider<SportEventSummaryDto>, DataProvider<RestMessage, SportEventSummaryDto>>(
                serviceProvider =>
                    new DataProvider<RestMessage, SportEventSummaryDto>(summaryEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<RestMessage, SportEventSummaryDto>>()));
            ...
            services.AddSingleton<IDataProvider<FixtureDto>, DataProvider<fixturesEndpoint, FixtureDto>>(
                serviceProvider =>
            ...
            services.AddSingleton<IDataProviderNamed<FixtureDto>, DataProviderNamed<fixturesEndpoint, FixtureDto>>(
                serviceProvider =>
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<tournamentInfoEndpoint, TournamentInfoDto>,
                    TournamentInfoMapperFactory>();
            services
                .AddSingleton<IDataProvider<TournamentInfoDto>,
                    DataProvider<tournamentInfoEndpoint, TournamentInfoDto>>(serviceProvider =>
                    new DataProvider<tournamentInfoEndpoint, TournamentInfoDto>(fixtureEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<tournamentInfoEndpoint, TournamentInfoDto>>()));

            // fixtureChangeFixture endpoint provider for tournament info
            services
                .AddSingleton<IDataProviderNamed<TournamentInfoDto>,
                    DataProviderNamed<tournamentInfoEndpoint, TournamentInfoDto>>(serviceProvider =>
                    new DataProviderNamed<tournamentInfoEndpoint, TournamentInfoDto>(
                        DataProviderForFixtureChangeFixtureEndpointForTournamentInfo,
                        fixtureChangeFixtureEndpoint,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<tournamentInfoEndpoint>>(),
                        serviceProvider
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<tournamentsEndpoint, EntityList<SportDto>>,
                    TournamentsMapperFactory>();
            services
                .AddSingleton<IDataProviderNamed<EntityList<SportDto>>,
                    DataProviderNamed<tournamentsEndpoint, EntityList<SportDto>>>(serviceProvider =>
                    new DataProviderNamed<tournamentsEndpoint, EntityList<SportDto>>(
                        DataProviderForAllTournamentsForAllSports,
                        allTournamentsForAllSport,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<tournamentsEndpoint>>(),
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<tournamentsEndpoint, EntityList<SportDto>>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<sportsEndpoint, EntityList<SportDto>>, SportsMapperFactory>();
            services
                .AddSingleton<IDataProviderNamed<EntityList<SportDto>>,
                    DataProviderNamed<sportsEndpoint, EntityList<SportDto>>>(serviceProvider =>
                    new DataProviderNamed<sportsEndpoint, EntityList<SportDto>>(DataProviderForAllSports,
                        ...
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<sportsEndpoint, EntityList<SportDto>>>()));
            ...
            services.AddSingleton<IDataProviderNamed<EntityList<SportEventSummaryDto>>, DateScheduleProvider>(
                serviceProvider =>
                    new DateScheduleProvider(DataProviderForDateSchedule,
                        ...
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<scheduleEndpoint, EntityList<SportEventSummaryDto>>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<tournamentSchedule, EntityList<SportEventSummaryDto>>,
                    TournamentScheduleMapperFactory>();
            services
                .AddSingleton<IDataProviderNamed<EntityList<SportEventSummaryDto>>,
                    DataProviderNamed<tournamentSchedule, EntityList<SportEventSummaryDto>>>(serviceProvider =>
                    new DataProviderNamed<tournamentSchedule, EntityList<SportEventSummaryDto>>(
                        DataProviderForTournamentSchedule,
                        tournamentSchedule,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<tournamentSchedule>>(),
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<tournamentSchedule,
                                EntityList<SportEventSummaryDto>>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<raceScheduleEndpoint, EntityList<SportEventSummaryDto>>,
                    TournamentRaceScheduleMapperFactory>();
            services
                .AddSingleton<IDataProviderNamed<EntityList<SportEventSummaryDto>>,
                    DataProviderNamed<raceScheduleEndpoint, EntityList<SportEventSummaryDto>>>(serviceProvider =>
                    new DataProviderNamed<raceScheduleEndpoint, EntityList<SportEventSummaryDto>>(
                        DataProviderForStageTournamentSchedule,
                        stageTournamentSchedule,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<raceScheduleEndpoint>>(),
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<raceScheduleEndpoint,
                                EntityList<SportEventSummaryDto>>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<tournamentSeasons, TournamentSeasonsDto>,
                    TournamentSeasonsMapperFactory>();
            services
                .AddSingleton<IDataProvider<TournamentSeasonsDto>,
                    DataProvider<tournamentSeasons, TournamentSeasonsDto>>(serviceProvider =>
                    new DataProvider<tournamentSeasons, TournamentSeasonsDto>(tournamentSeasons,
                        ...
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<tournamentSeasons, TournamentSeasonsDto>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<playerProfileEndpoint, PlayerProfileDto>,
                    PlayerProfileMapperFactory>();
            services
                .AddSingleton<IDataProvider<PlayerProfileDto>, DataProvider<playerProfileEndpoint, PlayerProfileDto>>(
                    serviceProvider =>
                        new DataProvider<playerProfileEndpoint, PlayerProfileDto>(playerProfileEndpoint,
                            ...
                            serviceProvider
                                .GetRequiredService<
                                    ISingleTypeMapperFactory<playerProfileEndpoint, PlayerProfileDto>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<competitorProfileEndpoint, CompetitorProfileDto>,
                    CompetitorProfileMapperFactory>();
            services
                .AddSingleton<IDataProvider<CompetitorProfileDto>,
                    DataProvider<competitorProfileEndpoint, CompetitorProfileDto>>(serviceProvider =>
                    new DataProvider<competitorProfileEndpoint, CompetitorProfileDto>(competitorProfileEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<competitorProfileEndpoint, CompetitorProfileDto>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<simpleTeamProfileEndpoint, SimpleTeamProfileDto>,
                    SimpleTeamProfileMapperFactory>();
            services
                .AddSingleton<IDataProvider<SimpleTeamProfileDto>,
                    DataProvider<simpleTeamProfileEndpoint, SimpleTeamProfileDto>>(serviceProvider =>
                    new DataProvider<simpleTeamProfileEndpoint, SimpleTeamProfileDto>(simpleTeamProfileEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<simpleTeamProfileEndpoint, SimpleTeamProfileDto>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<matchTimelineEndpoint, MatchTimelineDto>,
                    MatchTimelineMapperFactory>();
            services
                .AddSingleton<IDataProvider<MatchTimelineDto>, DataProvider<matchTimelineEndpoint, MatchTimelineDto>>(
                    serviceProvider =>
                        new DataProvider<matchTimelineEndpoint, MatchTimelineDto>(timelineEndpoint,
                            ...
                            serviceProvider
                                .GetRequiredService<
                                    ISingleTypeMapperFactory<matchTimelineEndpoint, MatchTimelineDto>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<sportCategoriesEndpoint, SportCategoriesDto>,
                    SportCategoriesMapperFactory>();
            services
                .AddSingleton<IDataProvider<SportCategoriesDto>,
                    DataProvider<sportCategoriesEndpoint, SportCategoriesDto>>(serviceProvider =>
                    new DataProvider<sportCategoriesEndpoint, SportCategoriesDto>(sportCategoriesEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<sportCategoriesEndpoint, SportCategoriesDto>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<fixtureChangesEndpoint, EntityList<FixtureChangeDto>>,
                    FixtureChangesMapperFactory>();
            services
                .AddSingleton<IDataProvider<EntityList<FixtureChangeDto>>,
                    DataProvider<fixtureChangesEndpoint, EntityList<FixtureChangeDto>>>(serviceProvider =>
                    new DataProvider<fixtureChangesEndpoint, EntityList<FixtureChangeDto>>(fixtureChangeEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<fixtureChangesEndpoint,
                                EntityList<FixtureChangeDto>>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<resultChangesEndpoint, EntityList<ResultChangeDto>>,
                    ResultChangesMapperFactory>();
            services
                .AddSingleton<IDataProvider<EntityList<ResultChangeDto>>,
                    DataProvider<resultChangesEndpoint, EntityList<ResultChangeDto>>>(serviceProvider =>
                    new DataProvider<resultChangesEndpoint, EntityList<ResultChangeDto>>(resultChangeEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<resultChangesEndpoint, EntityList<ResultChangeDto>>>()));

            // invariant market description list provider
            var invariantMarketListEndpoint =
                configuration.Api.BaseUrl + "/v1/descriptions/{0}/markets.xml?include_mappings=true";
            services.AddSingleton<IDeserializer<market_descriptions>, Deserializer<market_descriptions>>();
            services
                .AddSingleton<ISingleTypeMapperFactory<market_descriptions, EntityList<MarketDescriptionDto>>,
                    MarketDescriptionsMapperFactory>();
            services
                .AddSingleton<IDataProviderNamed<EntityList<MarketDescriptionDto>>,
                    DataProviderNamed<market_descriptions, EntityList<MarketDescriptionDto>>>(serviceProvider =>
                    new DataProviderNamed<market_descriptions, EntityList<MarketDescriptionDto>>(
                        DataProviderForInvariantMarketList,
                        invariantMarketListEndpoint,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<market_descriptions>>(),
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<market_descriptions,
                                EntityList<MarketDescriptionDto>>>()));

            // variant market description list provider
            var variantMarketListEndpoint =
                configuration.Api.BaseUrl + "/v1/descriptions/{0}/variants.xml?include_mappings=true";
            services.AddSingleton<IDeserializer<variant_descriptions>, Deserializer<variant_descriptions>>();
            services
                .AddSingleton<ISingleTypeMapperFactory<variant_descriptions, EntityList<VariantDescriptionDto>>,
                    VariantDescriptionsMapperFactory>();
            services
                .AddSingleton<IDataProviderNamed<EntityList<VariantDescriptionDto>>,
                    DataProviderNamed<variant_descriptions, EntityList<VariantDescriptionDto>>>(serviceProvider =>
                    new DataProviderNamed<variant_descriptions, EntityList<VariantDescriptionDto>>(
                        DataProviderForVariantMarketList,
                        variantMarketListEndpoint,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<variant_descriptions>>(),
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<variant_descriptions,
                                EntityList<VariantDescriptionDto>>>()));

            // single variant market description provider
            var singleVariantMarketListEndpoint = configuration.Api.BaseUrl +
                                                  "/v1/descriptions/{1}/markets/{0}/variants/{2}?include_mappings=true";
            services
                .AddSingleton<ISingleTypeMapperFactory<market_descriptions, MarketDescriptionDto>,
                    MarketDescriptionMapperFactory>();
            services
                .AddSingleton<IDataProviderNamed<MarketDescriptionDto>,
                    DataProviderNamed<market_descriptions, MarketDescriptionDto>>(serviceProvider =>
                    new DataProviderNamed<market_descriptions, MarketDescriptionDto>(DataProviderForVariantMarket,
                        ...
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<market_descriptions, MarketDescriptionDto>>()));
            ...
            services.AddSingleton<IDataProviderNamed<DrawDto>, DataProviderNamed<draw_summary, DrawDto>>(
                serviceProvider =>
            ...
            services.AddSingleton<IDataProviderNamed<DrawDto>, DataProviderNamed<draw_fixtures, DrawDto>>(
                serviceProvider =>
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<lottery_schedule, LotteryDto>, LotteryScheduleMapperFactory>();
            services.AddSingleton<IDataProvider<LotteryDto>, DataProvider<lottery_schedule, LotteryDto>>(
                serviceProvider =>
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<lotteries, EntityList<LotteryDto>>, LotteriesMapperFactory>();
            services
                .AddSingleton<IDataProvider<EntityList<LotteryDto>>, DataProvider<lotteries, EntityList<LotteryDto>>>(
                    serviceProvider =>
                        new DataProvider<lotteries, EntityList<LotteryDto>>(lotteryListEndpoint,
                            ...
                            serviceProvider
                                .GetRequiredService<ISingleTypeMapperFactory<lotteries, EntityList<LotteryDto>>>()));
            ...
            services
                .AddSingleton<IDataProviderNamed<EntityList<SportEventSummaryDto>>,
                    DataProviderNamed<scheduleEndpoint, EntityList<SportEventSummaryDto>>>(serviceProvider =>
                    new DataProviderNamed<scheduleEndpoint, EntityList<SportEventSummaryDto>>(
                        DataProviderForSportEventList,
            ...
            var sportAvailableTournamentsEndpoint =
                configuration.Api.BaseUrl + "/v1/sports/{0}/sports/{1}/tournaments.xml";
            services.AddSingleton<IDeserializer<sportTournamentsEndpoint>, Deserializer<sportTournamentsEndpoint>>();
            services
                .AddSingleton<ISingleTypeMapperFactory<sportTournamentsEndpoint, EntityList<TournamentInfoDto>>,
                    ListSportAvailableTournamentMapperFactory>();
            services
                .AddSingleton<IDataProvider<EntityList<TournamentInfoDto>>,
                    DataProvider<sportTournamentsEndpoint, EntityList<TournamentInfoDto>>>(serviceProvider =>
                    new DataProvider<sportTournamentsEndpoint, EntityList<TournamentInfoDto>>(
                        sportAvailableTournamentsEndpoint,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<sportTournamentsEndpoint>>(),
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<sportTournamentsEndpoint,
            ...
            var stagePeriodSummaryEndpoint =
                configuration.Api.BaseUrl + "/v1/sports/{0}/sport_events/{1}/period_summary.xml{2}";
            services.AddSingleton<IDeserializer<stagePeriodEndpoint>, Deserializer<stagePeriodEndpoint>>();
            services
                .AddSingleton<ISingleTypeMapperFactory<stagePeriodEndpoint, PeriodSummaryDto>,
                    PeriodSummaryMapperFactory>();
            services.AddSingleton<IDataProvider<PeriodSummaryDto>, DataProvider<stagePeriodEndpoint, PeriodSummaryDto>>(
                serviceProvider =>
                    new DataProvider<stagePeriodEndpoint, PeriodSummaryDto>(stagePeriodSummaryEndpoint,
                        ...
                        serviceProvider
                            .GetRequiredService<ISingleTypeMapperFactory<stagePeriodEndpoint, PeriodSummaryDto>>()));

            // custom bet available selections provider
            var customBetAvailableSelectionsEndpoint =
                configuration.Api.BaseUrl + "/v1/custombet/{0}/available_selections";
            services.AddSingleton<IDeserializer<AvailableSelectionsType>, Deserializer<AvailableSelectionsType>>();
            services
                .AddSingleton<ISingleTypeMapperFactory<AvailableSelectionsType, AvailableSelectionsDto>,
                    AvailableSelectionsMapperFactory>();
            services
                .AddSingleton<IDataProvider<AvailableSelectionsDto>,
                    DataProvider<AvailableSelectionsType, AvailableSelectionsDto>>(serviceProvider =>
                    new DataProvider<AvailableSelectionsType, AvailableSelectionsDto>(
                        customBetAvailableSelectionsEndpoint,
                        serviceProvider.GetRequiredService<ILogHttpDataFetcher>(),
                        serviceProvider.GetRequiredService<IDeserializer<AvailableSelectionsType>>(),
                        serviceProvider
                            .GetRequiredService<
                                ISingleTypeMapperFactory<AvailableSelectionsType, AvailableSelectionsDto>>()));
            ...
            services
                .AddSingleton<ISingleTypeMapperFactory<CalculationResponseType, CalculationDto>,
                    CalculationMapperFactory>();
            services.AddSingleton<ICalculateProbabilityProvider, CalculateProbabilityProvider>(serviceProvider =>
                new CalculateProbabilityProvider(customBetCalculateEndpoint,
                    ...
                    serviceProvider
                        .GetRequiredService<ISingleTypeMapperFactory<CalculationResponseType, CalculationDto>>()));
            ...
            services
                .AddSingleton<IDeserializer<FilteredCalculationResponseType>,
                    Deserializer<FilteredCalculationResponseType>>();
            services
                .AddSingleton<ISingleTypeMapperFactory<FilteredCalculationResponseType, FilteredCalculationDto>,
                    CalculationFilteredMapperFactory>();
            services.AddSingleton<ICalculateProbabilityFilteredProvider, CalculateProbabilityFilteredProvider>(
                serviceProvider =>
            ...
            services.AddSingleton<IDataRouterManager, DataRouterManager>(serviceProvider =>
                new DataRouterManager(
                    ...
                    serviceProvider.GetDataProviderNamed<EntityList<SportDto>>(
                        DataProviderForAllTournamentsForAllSports),
                    ...
                    serviceProvider.GetDataProviderNamed<EntityList<SportEventSummaryDto>>(
                        DataProviderForTournamentSchedule),
                    ...
                    serviceProvider.GetDataProviderNamed<EntityList<MarketDescriptionDto>>(
                        DataProviderForInvariantMarketList),
                    serviceProvider.GetDataProviderNamed<MarketDescriptionDto>(DataProviderForVariantMarket),
                    serviceProvider.GetDataProviderNamed<EntityList<VariantDescriptionDto>>(
                        DataProviderForVariantMarketList),
                    ...
                    serviceProvider.GetDataProviderNamed<TournamentInfoDto>(
                        DataProviderForFixtureChangeFixtureEndpointForTournamentInfo),
        ...
        private static void RegisterNamedValueCaches(IServiceCollection services, IUofConfiguration configuration)
        {
            ...
            services.AddSingleton<IDataProviderNamed<EntityList<NamedValueDto>>, NamedValueDataProvider>(
                serviceProvider =>
            ...
            services.AddSingleton<INamedValueCache, NamedValueCache>(serviceProvider =>
                new NamedValueCache(NamedValueCacheNameForVoidReason,
                    serviceProvider.GetRequiredService<IUofConfiguration>().ExceptionHandlingStrategy,
                    serviceProvider.GetDataProviderNamed<EntityList<NamedValueDto>>(
                        DataProviderForNamedValueCacheVoidReason),
            ...
            services.AddSingleton<INamedValueCache, NamedValueCache>(serviceProvider =>
                new NamedValueCache(NamedValueCacheNameForBetStopReason,
                    serviceProvider.GetRequiredService<IUofConfiguration>().ExceptionHandlingStrategy,
                    serviceProvider.GetDataProviderNamed<EntityList<NamedValueDto>>(
                        DataProviderForNamedValueCacheBetStopReason),
                    serviceProvider.GetSdkTimer(TimerForNamedValueCache)
                ));
            ...
            services.AddSingleton<INamedValueCache, NamedValueCache>(serviceProvider =>
                new NamedValueCache(NamedValueCacheNameForBettingStatus,
                    serviceProvider.GetRequiredService<IUofConfiguration>().ExceptionHandlingStrategy,
                    serviceProvider.GetDataProviderNamed<EntityList<NamedValueDto>>(
                        DataProviderForNamedValueCacheBettingStatus),
                    serviceProvider.GetSdkTimer(TimerForNamedValueCache)
                ));
            ...
            services.AddSingleton<ILocalizedNamedValueCache, LocalizedNamedValueCache>(serviceProvider =>
                new LocalizedNamedValueCache(NamedValueCacheNameForMatchStatus,
                    serviceProvider.GetRequiredService<IUofConfiguration>().ExceptionHandlingStrategy,
                    serviceProvider.GetDataProviderNamed<EntityList<NamedValueDto>>(
                        DataProviderForNamedValueCacheMatchStatus),
                    serviceProvider.GetSdkTimer(TimerForNamedValueCache),
        ...
        private static void RegisterTelemetry(IServiceCollection services)
        {
            services.AddOpenTelemetry()
                .WithTracing(
                    traceProviderBuilder => traceProviderBuilder.AddSource(UofSdkTelemetry.ActivitySource.Name))
                .WithMetrics(metricsProviderBuilder =>
                    metricsProviderBuilder.AddMeter(UofSdkTelemetry.DefaultMeter.Name));
        }
    }
}